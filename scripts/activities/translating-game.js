...
function handleResponse(message) {
	try {
		if (message.content === global.gameVariables.answer) {
			...
			inSeconds = (global.gameVariables.elapsed / 1000).toFixed(2);
			global.gameVariables.fullTime = global.gameVariables.fullTime || 0;
			unroundedNum = parseFloat(global.gameVariables.fullTime) + parseFloat(inSeconds);
			...
			if (global.gameVariables.roundCount < 5) {
				...
				winners = global.gameVariables.winners;
				fullTime = global.gameVariables.fullTime;
